...
-define(FATE_BYTECODE_T,  {bytecode, binary()}).
...
-define(IS_FATE_BYTECODE(X), (is_tuple(X) andalso tuple_size(X) =:= 2 andalso element(1, X) =:= bytecode
...
-define(FATE_BYTECODE_SIZE(X), (byte_size(X))).
