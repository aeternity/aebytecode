...
ops_defs() ->
    ...
    , { 'CALL_R',              16#03,   true,   false,   true,  ?GAS_IRIS(100, 5000), [a,is,a,a,a],     call_r, {contract, string, typerep, typerep, integer},     any, "Remote call to contract Arg0 and function Arg1 of type Arg2 => Arg3 with value Arg4. The types of the arguments has to match the argument types of the function."}
    ...
    , { 'CALL_GR',             16#05,   true,   false,   true,  ?GAS_IRIS(100, 5000), [a,is,a,a,a,a],   call_gr, {contract, string, typerep, typerep, integer, integer}, any, "Remote call with gas cap in Arg4. Otherwise as CALL_R."}
    ...
    , { 'CALL_PGR',            16#a2,   true,   false,   true, ?GAS_IRIS(100, 5000), [a,is,a,a,a,a,a],  call_pgr, {contract, string, typerep, typerep, integer, integer, bool}, variant, "Potentially protected remote call. Arg5 is protected flag, otherwise as CALL_GR."}
